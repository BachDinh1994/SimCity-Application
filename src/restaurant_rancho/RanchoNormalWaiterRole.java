...
public class RanchoNormalWaiterRole extends Role implements Waiter {
	...
	public RanchoNormalWaiterRole(RanchoHost host,RanchoCook cook,Cashier cashier,String name) {
		super();
		this.name=name;
		this.host=host;
		this.cook=cook;
