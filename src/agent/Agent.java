...
//Understood procedural instructions
/**
...
public abstract class Agent {
    ...
    public class AgentThread extends Thread {
        ...
        public Semaphore pauseS = new Semaphore(0); //allows another thread to wake this up
    ...
    public AgentThread getThread() //allows execution to be done in the base agent by getting its thread
    {
    	return agentThread;
    }
}
