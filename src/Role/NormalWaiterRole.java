...
import Role.WaiterRole.customerstate;
import agent.Agent;
 ...
 */
public class NormalWaiterRole extends Role implements Waiters//Complete implementation
{
	Check check;
	...
	public void waiterResting(final NormalWaiterRole w)
	{
	...
	private void SendOrderToCook(Customer c)
	{
		foodGui.showChoice();
		waiterGui.GoToCook();
		cook.msgHereIsOrder(this,c.choice,c.table,foodGui);
		c.s = customerstate.stop;
		timer.schedule(new TimerTask()
		{
			public void run()
