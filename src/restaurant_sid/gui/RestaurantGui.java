...
public class RestaurantGui extends JFrame implements ActionListener {
    ...
    public void updateInfoPanel(Object person) {
        ...
        if (person instanceof SidCustomerRole) {
            SidCustomerRole customer = (SidCustomerRole) person;
        ...
        } else if (person instanceof SidWaiterRole){
        	SidWaiterRole waiter = (SidWaiterRole) person;
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == stateCB) {
            if (currentPerson instanceof SidCustomerRole) {
                SidCustomerRole c = (SidCustomerRole) currentPerson;
                c.getGui().setHungry();
                stateCB.setEnabled(false);
            } else if (currentPerson instanceof SidWaiterRole){
            	SidWaiterRole w = (SidWaiterRole) currentPerson;
            	w.getGui().WantBreak();
            	stateCB.setEnabled(false);
            }
     ...
     */
    public void setCustomerEnabled(SidCustomerRole c) {
        if (currentPerson instanceof SidCustomerRole) {
            SidCustomerRole cust = (SidCustomerRole) currentPerson;
            if (c.equals(cust)) {
                stateCB.setEnabled(true);
                stateCB.setSelected(false);
            }
