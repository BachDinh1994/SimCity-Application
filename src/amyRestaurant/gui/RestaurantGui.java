...
public class RestaurantGui extends JFrame implements ActionListener {
	...
	public void updateInfoPanel(String type, Object person, Boolean check) {
		...
		if(type.equals("Customers")){
			...
			if (person instanceof AmyCustomerRole) {
				stateCB.setVisible(true);

				AmyCustomerRole customer = (AmyCustomerRole) person;
				if(check)
				{
			...
			if (person instanceof AmyWaiterRole) {
				stateCB.setVisible(true);
				AmyWaiterRole waiter = (AmyWaiterRole) person;
				//if(check)
				//{
	...
	public void updateBreak(String message, AmyWaiterRole person){
		stateCB.setVisible(true);
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == stateCB) {
			if (currentPerson instanceof AmyCustomerRole) {
				AmyCustomerRole c = (AmyCustomerRole) currentPerson;
				c.getGui().setHungry();

				stateCB.setEnabled(false);}
			else if(currentPerson instanceof AmyWaiterRole) {
				AmyWaiterRole w = (AmyWaiterRole) currentPerson;
	 ...
	 */
	public void setCustomerEnabled(AmyCustomerRole c) {
		if (currentPerson instanceof AmyCustomerRole) {
			AmyCustomerRole cust = (AmyCustomerRole) currentPerson;
			if (c.equals(cust)) {
				stateCB.setEnabled(true);
				stateCB.setSelected(false);
			}
