...
public class AmyWaiterRole extends Role implements AmyWaiter {
	...
	public AmyWaiterRole(String name) {
		super();
		//set menu
	...
	public void HereIsOrder(String orderChoice, int tableNumber)
	{
		...
		((AmyCookAgent)amyCook).orders.insert(orderChoice,tableNumber,this);
		//amyCook.msgHereIsOrder(orderChoice, tableNumber, this); // added pointer to waiter so cook knows who to call? is this a bad idea?
		amyWaiterGui.DoLeaveCustomer();
