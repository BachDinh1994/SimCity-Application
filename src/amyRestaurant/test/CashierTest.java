package amyRestaurant.test;

import amyRestaurant.AmyCashierAgent;
import amyRestaurant.AmyCashierAgent.billState;
import amyRestaurant.AmyCashierAgent.checkState;
import amyRestaurant.test.mock.LoggedEvent;
import amyRestaurant.test.mock.MockBank;
import amyRestaurant.test.mock.MockCustomer;
import amyRestaurant.test.mock.MockMarket;
import amyRestaurant.test.mock.MockWaiter;
...
public class CashierTest extends TestCase
{
	...
	public void setUp() throws Exception{
		super.setUp();		
		cashier = new AmyCashierAgent("cashier");		
	...
	public void testOneNormalCustomerScenario()
	{
		...
		customer.amyCashier = cashier;//You can do almost anything in a unit test.			
	...
	public void testFourNormalMarketScenario(){
		market1.amyCashier = cashier;//You can do almost anything in a unit test.		
		...
		assertTrue("Market1 is communicating with the correct cashier. Instead, the Market1's cashier's name: "  
				+ market1.amyCashier.getName(), cashier.equals(market1.amyCashier));
	...
	public void testFiveNormalMarketScenario(){
		market1.amyCashier = cashier; //two markets	
		market2.amyCashier = cashier;
		...
		assertTrue("Market2 is communicating with the correct cashier. Instead, the Market2's cashier's name: "  
				+ market2.amyCashier.getName(), cashier.equals(market2.amyCashier));		
