 ...
 */
public class CustomerAgent extends Agent implements Customers //Complete implementation
{
	...
	{
		print ("Customer got message out of food");
		print ("Finding something to reorder...");
	...
	public void msgPleaseWaitFullRestaurant(final Customers c)
	{
		...
		else
		{
			...
			waitingtimer.schedule(new TimerTask() 
			{
			    public void run() 
			    {  
			    	print ("Can't wait anymore! I'm outta here");   
			    	events.add(AgentEvent.outofhere);
	...
	protected boolean pickAndExecuteAnAction() 
	{
		...
		if (event == AgentEvent.stopping)
		{
			stop();
			return false;
		}
		else if (event == AgentEvent.leaving) //Leave if restaurant's out of choice
		{
	...
	public void payCheck()
	{
		...
		cash -= check.price;
		print ("My cash value is now "+cash);
	}
    ...
    private void orderFood()
    {
		...
		//waiter.msgHereIsMyOrder(this, "Pork");
